...
System.register(['../models/ListaNegociacoes', '../models/Mensagem', '../models/Negociacao', '../views/NegociacoesView', '../views/MensagemView', '../services/NegociacaoService', '../helpers/DateHelper', '../helpers/Bind'], function (_export, _context) {
    ...
    return {
        setters: [function (_modelsListaNegociacoes) {
            ...
            NegociacaoView = _viewsNegociacoesView.NegociacaoView;
                ...
                _createClass(NegociacaoController, [{
                    ...
                    value: function importaNegociacoes() {
                        ...
                        this._negociacaoService.importa(this._listaNegociacoes.negociacoes).then(function (negociacoes) {
                            negociacoes.reduce(function (arrayTransformado, array) {
                                return arrayTransformado.concat(array);
                            }, []).forEach(function (negociacao) {
                                return _this4._listaNegociacoes.adiciona(negociacao);
                            });
                            _this4._mensagem.texto = 'Negociações da semana obtidas com sucesso';
                        }).catch(function (erro) {
